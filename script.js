...
const CUSTOMER_SERVICE_URL = 'https://example.com/'; // 将此替换为你的客服链接

// 一次机会限制的存储键
const STORAGE_KEY = 'lucky_wheel_played';

// 奖品配置（默认占位图，建议替换为百度图片的实际图片链接）
// 在 https://image.baidu.com/ 搜索后，将 image 字段替换为对应图片URL
const PRIZES = [
  ...
  { name: '四等奖 扫地机器人', image: 'https://via.placeholder.com/120?text=%E6%8A%8A%E5%9C%B0%E6%9C%BA%E5%99%A8%E4%BA%BA' },
